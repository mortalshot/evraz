(() => {
    ...
    function initSliders() {
        if (document.querySelector(".widget-news__slider")) new swiper_core_Swiper(".widget-news__slider", {
            ...
            navigation: {
                prevEl: ".widget-news .swiper-arrows__arrow_prev",
                nextEl: ".widget-news .swiper-arrows__arrow_next"
            },
            breakpoints: {
                480: {
                    slidesPerView: 1.6
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (window.innerWidth > 991.98) {
            ...
            if (!targetElement.closest(".menu-item-has-children") && document.querySelectorAll(".menu-item-has-children._hover").length > 0) removeClasses(document.querySelectorAll(".menu-item-has-children._hover"), "_hover");
        }
        if (window.innerWidth < 991.98) if (targetElement.closest(".menu__arrow")) {
    ...
    if (ticker.length > 0) ticker.forEach((element => {
    ...
    function gsapAnimations() {
        ...
        if (firstscreen) {
            ...
            if (fsTitles.length > 0) fsTitles.forEach((element => {
            ...
            if (fsSubtitles.length > 0) fsSubtitles.forEach((element => {
                firstscreenTL.from(element, {
                    opacity: 0,
                    xPercent: -50
                }, "-=0.2");
            ...
            if (fsActions) firstscreenTL.from(fsActions, {
                opacity: 0
            }, "-=0.2");
        }
        ...
        if (platform) {
            ...
            if (platformImage) platformTL.from(platformImage, {
                xPercent: -50,
                opacity: 0
            });
            const platformTitle = platform.querySelectorAll(".platform__title *");
            if (platformTitle.length > 0) platformTitle.forEach((element => {
            ...
            if (platformCaption) platformTL.from(platformCaption, {
                xPercent: -50,
                opacity: 0
            }, "-0.1");
            const platformText = platform.querySelectorAll(".platform__text *");
            if (platformText.length > 0) platformText.forEach((element => {
                platformTL.from(element, {
                    xPercent: -30,
                    opacity: 0
                }, "-0.1");
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        ...
        setTimeout((() => {
            showHeaderHeight();
            if (window.innerWidth >= 768) gsapAnimations();
        }), 300);
        ymaps.ready((function() {
            ...
            var lastCollection = 0, lastActiveRegion = 0;
            var lng = "ru", contr = "RU", level = "1";
            if (lastCollection) geoMap.geoObjects.remove(lastCollection);
            ymaps.regions.load(contr, {
                ...
                lastCollection.events.add("click", (function(event) {
                    ...
                    if (lastActiveRegion) lastActiveRegion.options.set("preset", "");
                ...
                var myPlacemark4 = new ymaps.GeoObject({
                    geometry: {
                        type: "Point",
                        coordinates: [ 63.33577, 36.146574 ]
                    },
                    properties: {
